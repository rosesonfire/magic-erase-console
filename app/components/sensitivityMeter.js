  ...
  render () {
    return this.props.hide ? null : (
      <fieldset className='big resize fixed-height'>
        ...
        <input type='number' min='0.1' max='100' value={this.props.value} onChange={this.onChange} />
        <input className='wide' type='range' step='0.1' min='0.1' value={this.props.value} onChange={this.onChange} />
      </fieldset>
    )
  }
}
